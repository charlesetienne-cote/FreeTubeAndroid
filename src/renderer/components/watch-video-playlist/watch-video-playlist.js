...
export default defineComponent({
  ...
  methods: {
    getPlaylistInfoWithDelay: function () {
      ...
      } else if (!(process.env.IS_ELECTRON || process.env.IS_ANDROID) || this.backendPreference === 'invidious') {
        this.getPlaylistInformationInvidious()
      } else {
        this.getPlaylistInformationLocal()
      }
    ...
    loadCachedPlaylistInformation: async function (cachedPlaylist) {
      ...
      if (!(process.env.IS_ELECTRON || process.env.IS_ANDROID) || this.backendPreference === 'invidious' || cachedPlaylist.continuationData === null) {
